...
class _CreateGroupScreenState extends ConsumerState<CreateGroupScreen> {
  ...
  Future<void> saveGroupSettings() async {
    ...
    ref.read(groupProfilesProvider.notifier).editGroupProfile(
      groupId!,
      groupName,
      iconLink,
    );
  ...
  @override
  // Assume that this GlobalKey is declared in the state class:
    ...
    if (isInit) {
      ref.read(profileProvider.notifier).loadMyProfile().then((_) {
        ...
        if (args != null) {
          ...
          profiles[ref.read(profileProvider).userUID] = ref.read(
            profileProvider,
          );
        }
        if (isNewGroup) {
          ...
          ElevatedButton(
            onPressed: () {
              if (_formKey.currentState!.validate()) {
                if ((_selectedIcon == null) && (iconImage == null)) {
                ...
                if (_selectedIcon != null && !setImage) ...[
                  ...
                  CircleAvatar(
                    ...
                    backgroundImage: NetworkImage(
                      _selectedIcon ?? Statics.defaultIconLink,
                    ),
                  ),
                ],
                if (setImage) ...[
